lib/codemirror.js built from tag `5.42.0` using yarn 1.12.3.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1552333355012-0.3668616457185756/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.42.0 build /home/bpaskinc/md/mathdown/CodeMirror
> rollup -c
...
Done in 21.24s.
$ npm list --depth=0
codemirror@5.42.0 /home/bpaskinc/md/mathdown/CodeMirror
├── blint@1.0.3
├── node-static@0.7.11
