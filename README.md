lib/codemirror.js built from tag `5.56.0` using yarn 1.22.10.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1611256060954-0.3936888389947013/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.56.0 build /home/cben/md/mathdown/CodeMirror
> rollup -c
...
created addon/runmode/runmode-standalone.js in 122ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 134ms
Done in 42.95s.
$ npm list --depth=0
codemirror@5.56.0 /home/cben/md/mathdown/CodeMirror
...
src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 116ms
