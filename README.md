lib/codemirror.js built from tag `5.44.0` using yarn 1.12.3.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1552333399717-0.5110261156942248/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.44.0 build /home/bpaskinc/md/mathdown/CodeMirror
> rollup -c
...
Done in 17.40s.
$ npm list --depth=0
codemirror@5.44.0 /home/bpaskinc/md/mathdown/CodeMirror
├── blint@1.0.3
├── node-static@0.7.11
