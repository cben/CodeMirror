lib/codemirror.js built from tag `5.39.2` using yarn 1.9.4.
...
> codemirror@5.39.2 build /home/bpaskinc/md/mathdown/CodeMirror
> rollup -c

Done in 11.34s.
$ npm list --depth=0
codemirror@5.39.2 /home/bpaskinc/md/mathdown/CodeMirror
├── blint@1.0.3
├── node-static@0.6.0
