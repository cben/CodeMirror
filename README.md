lib/codemirror.js built from tag `5.54.0` using yarn 1.22.10.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1611255963120-0.9862299056313941/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.54.0 build /home/cben/md/mathdown/CodeMirror
> rollup -c
...
...and 3 more
created lib/codemirror.js in 4s
Done in 42.92s.
$ npm list --depth=0
codemirror@5.54.0 /home/cben/md/mathdown/CodeMirror
├── blint@1.1.1
├── node-static@0.7.11
├── puppeteer@1.20.0
├── rollup@1.32.1
