lib/codemirror.js built from tag `5.59.1` using yarn 1.22.10.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1611256394258-0.7498228003154861/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.59.1 build /home/cben/md/mathdown/CodeMirror
> rollup -c
...
...and 4 more
created lib/codemirror.js in 8s

src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 291ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 390ms
Done in 51.63s.
$ npm list --depth=0
codemirror@5.59.1 /home/cben/md/mathdown/CodeMirror
...
src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 166ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 249ms
```
