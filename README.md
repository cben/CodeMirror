lib/codemirror.js built from tag `5.57.0` using yarn 1.22.10.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1611256110665-0.977082032891357/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.57.0 build /home/cben/md/mathdown/CodeMirror
> rollup -c
...
created addon/runmode/runmode-standalone.js in 136ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 111ms
Done in 37.19s.
$ npm list --depth=0
codemirror@5.57.0 /home/cben/md/mathdown/CodeMirror
...
src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 120ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 129ms
```
