lib/codemirror.js built from tag `5.32.0` using yarn 1.9.4.
...
> codemirror@5.32.0 build /home/bpaskinc/md/mathdown/CodeMirror
> rollup -c

Done in 11.16s.
$ npm list --depth=0
codemirror@5.32.0 /home/bpaskinc/md/mathdown/CodeMirror
├── blint@1.0.3
├── node-static@0.6.0
