lib/codemirror.js built from tag `5.48.2` using yarn 1.22.10.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1611255483353-0.21702044417767108/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.48.2 build /home/cben/md/mathdown/CodeMirror
> rollup -c
...
Done in 17.82s.
$ npm list --depth=0
codemirror@5.48.2 /home/cben/md/mathdown/CodeMirror
├── blint@1.1.1
├── node-static@0.7.11
