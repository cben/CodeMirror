lib/codemirror.js built from tag `5.35.0` using yarn 1.9.4.
...
> codemirror@5.35.0 build /home/bpaskinc/md/mathdown/CodeMirror
> rollup -c

Done in 13.30s.
$ npm list --depth=0
codemirror@5.35.0 /home/bpaskinc/md/mathdown/CodeMirror
├── blint@1.0.3
├── node-static@0.6.0
