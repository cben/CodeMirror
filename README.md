lib/codemirror.js built from tag `5.58.3` using yarn 1.22.10.
...
npm WARN lifecycle The node binary used for scripts is /tmp/yarn--1611256307142-0.4692525972303647/node but npm is using /usr/bin/node itself. Use the `--scripts-prepend-node-path` option to include the path for the node binary npm was executed with.

> codemirror@5.58.3 build /home/cben/md/mathdown/CodeMirror
> rollup -c
...
created addon/runmode/runmode-standalone.js in 117ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 125ms
Done in 36.44s.
$ npm list --depth=0
codemirror@5.58.3 /home/cben/md/mathdown/CodeMirror
...
src/addon/runmode/runmode-standalone.js → addon/runmode/runmode-standalone.js...
created addon/runmode/runmode-standalone.js in 133ms

src/addon/runmode/runmode.node.js → addon/runmode/runmode.node.js...
created addon/runmode/runmode.node.js in 131ms
```
