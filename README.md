lib/codemirror.js built from tag `5.20.0` using yarn 1.9.4.
...
> codemirror@5.20.0 build /home/bpaskinc/md/mathdown/CodeMirror
> rollup -c

Done in 10.35s.
$ npm list --depth=0
codemirror@5.20.0 /home/bpaskinc/md/mathdown/CodeMirror
├── blint@0.5.1
├── node-static@0.6.0
